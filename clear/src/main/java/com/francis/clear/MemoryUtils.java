...
public class MemoryUtils {
    ...
    public static void cleanMemory(Context context,EditText editText) {
        ...
        long allMemory = getTotalMemory();
        long beforeCleanMemory=getAvailMemory(context);
        double result1 = (double)(allMemory-beforeCleanMemory)*100/allMemory;
        System.out.println("---> 清理前可用内存大小:"+beforeCleanMemory+"M");
        System.out.println("---> 清理前已用内存大小:"+(allMemory-beforeCleanMemory)+"M");
        System.out.println("---> 清理前总内存大小:"+allMemory+"M");
        System.out.println("---> 已用内存比例："+result1+"%");
        System.out.println("---> 已用内存比例："+df.format(result1)+"%");
        ...
        System.out.println("--------------------------------------------------------------");
        double result2 = (double)(allMemory-afterCleanMemory)*100/allMemory;
        System.out.println("---> 清理后可用内存大小:"+afterCleanMemory+"M");
        System.out.println("---> 节约内存大小:" + (afterCleanMemory - beforeCleanMemory) + "M");
        System.out.println("---> 清理后已用内存大小:"+(allMemory-afterCleanMemory)+"M");
        System.out.println("---> 清理后总内存大小:"+allMemory+"M");
        System.out.println("---> 已用内存比例："+result2+"%");
        System.out.println("---> 已用内存比例："+df.format(result2)+"%");
